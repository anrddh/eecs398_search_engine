...
int main() {
   ...
   offsets.pushBack( {"Hello world!", file.addStr( "Hello world!", {0,0} )});
   offsets.pushBack( {"Testing this thing", file.addStr( "Testing this thing", {0,0})});
   offsets.pushBack( {"", file.addStr( "", {0,0} )});
   offsets.pushBack( {"after empty string", file.addStr( "after empty string", {0,0} )});
   offsets.pushBack( {"Hello world!", file.addStr( "Hello world!", {64,64} )});
   offsets.pushBack( {"Testing this thing", file.addStr( "Testing this thing", {128,128})});
   offsets.pushBack( {"", file.addStr( "", {0,0} )});
   offsets.pushBack( {"after empty string", file.addStr( "after empty string", {192,192} )});
